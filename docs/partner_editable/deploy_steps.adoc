...
. Confirm that your AWS account is configured correctly and that you have your Nubeva token, as discussed in the <<pre_reqs,Preequisites>> section.
...
[cols=2*]
|===
^|https://fwd.aws/3xyNN[Deploy Nubeva SKI into a new VPC on AWS^]
^|https://fwd.aws/Bx7em[View template^]

^|https://fwd.aws/wxQDK[Deploy Nubeva SKI into an existing VPC on AWS^]
^|https://fwd.aws/GjYVw[View template^]
|===
+
WARNING: If you’re deploying {partner-company-name} SKI into an existing VPC, make sure that your VPC has two private subnets in different Availability Zones for the workload instances, and that the subnets aren’t shared. This Quick Start doesn’t support https://docs.aws.amazon.com/vpc/latest/userguide/vpc-sharing.html[shared subnets]. These subnets require https://docs.aws.amazon.com/vpc/latest/userguide/vpc-nat-gateway.html[NAT gateways] in their route tables, to allow the instances to download packages and software without exposing them to the internet.
+
